...
import PendingOemReview from './PendingOemReview'
import { getPendingOemCount } from '../services/adminApi'
...
export default function OemMaintenance({ showToast }) {
  ...
  // Poll for pending count so the badge stays live
    ...
    <>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
        <div style={{ display: 'flex', gap: 4,
          borderBottom: `2px solid ${C.cardBorder}`, marginBottom: 22 }}>
          {[
      ...
      {/* Schedules sub-tab — original content */}
      {activeTab === 'schedules' && <>
      {/* Page content */}
